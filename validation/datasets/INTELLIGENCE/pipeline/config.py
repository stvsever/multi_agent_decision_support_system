...
TIERS = [
    {"id": "T1_demographics", "label": "Tier 1: Demographics",
     "groups": ["demographics"]},
    {"id": "T2_personality_psychometric",
     "label": "Tier 2: + Personality and psychometrics (Big Five, BIS/BAS, STAI)",
     "groups": ["demographics", "personality", "motivation_affect"]},
    {"id": "T3_identity", "label": "Tier 3: + Identity & Belief (all self-report)",
     "groups": ["demographics", "personality", "motivation_affect", "identity_belief"]},
    {"id": "T4_morphometry", "label": "Tier 4: + Brain morphometry",
     "groups": ["demographics", "personality", "motivation_affect", "identity_belief",
                "brain_morphometry"]},
    {"id": "T5_connectome", "label": "Tier 5: + Brain connectome (full multimodal)",
     "groups": ["demographics", "personality", "motivation_affect", "identity_belief",
                "brain_morphometry", "brain_connectome"]},
